# ML & DA
В данном репозитории вы можете ознакомиться с моими работами по анализу данных и машинному обучению.
...
* Working with Rare Categories
* Feature transformation 
* Predicting the total ride duration of taxi trips 
